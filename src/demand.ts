...
import { MachineObject, PermissionObject, GuardObject, RepositoryObject, ValueType, SUI_TYPE, DemandObject} from 'wowok/src/protocol';
...
export const test_demand_yes = async (txb:TransactionBlock, param:any) => {
    ...
    present(SUI_TYPE, SUI_TYPE, txb, d, service1, 'hello, service here');
    present(SUI_TYPE, SUI_TYPE, txb, d, service2, 'SERVICE 2');
