...
var ke = !!process.env.GITHUB_ACTIONS;
...
function diagnosticMessage(e) {
  ...
  return text([ Ve, cmd(Ee.Style, be.BrightBlack), `${e.line}:${e.col}`, xe.Tab, cmd(Ee.Style, t), e.severity, xe.Tab, cmd(Ee.Style, be.Foreground), indent(e.message.trim(), text([ Ve, xe.Tab, xe.Tab ])), xe.Newline ]);
}
...
var stat = async (e, t = He.File) => await l.stat(e).then((e => {
  switch (t) {
   case He.File:
    return e.isFile();
...
var Ke = /^(?:graphql\.config|\.graphqlrc)\.(?:cjs|[jt]s|json|toml|ya?ml)$/i;
...
var findGraphQLConfig = async t => {
  ...
  while (r !== n) {
    ...
    var a = i.find((e => Ke.test(e)));
    if (a) {
      return a;
    }
    if (await stat(e.resolve(r, ".git"), He.Directory)) {
      break;
    } else if (await stat(e.resolve(r, ".vscode"), He.Directory)) {
      break;
    }
    r = e.resolve(r, "..");
  }
...
var isVSCodeInstalled = async () => {
  ...
  return !!await stat(t, He.Directory);
};
...
function runningTask(e) {
  return pipe(interval(150), map((t => text([ emptyLine(), cmd(Ee.Style, be.Magenta), Te[t % Te.length], " ", cmd(Ee.Style, be.Foreground), e.trim() ]))));
}
...
var semiverComply = (e, t) => {
  ...
  return r ? function semiver(e, t, r) {
    e = e.split(".");
    t = t.split(".");
    return qe(e[0], t[0]) || qe(e[1], t[1]) || (t[2] = t.slice(2).join("."), (r = /[.-]/.test(e[2] = e.slice(2).join("."))) == /[.-]/.test(t[2]) ? qe(e[2], t[2]) : r ? -1 : 1);
  }(r[0], t) >= 0 : !1;
};
...
async function* run$1() {
  yield function title(e, t) {
    ...
    return r;
  }(Ye.TITLE, Ye.DESCRIPTION);
  yield runningTask(Ye.CHECK_TS_VERSION);
  await delay();
  var e = process.cwd();
  ...
  try {
    ...
    yield failedTask(Ye.CHECK_TS_VERSION);
  ...
  yield completedTask(Ye.CHECK_TS_VERSION);
  yield runningTask(Ye.CHECK_DEPENDENCIES);
  await delay();
  var f = c.find((e => "@0no-co/graphqlsp" === e[0]));
  if (!f) {
    yield failedTask(Ye.CHECK_DEPENDENCIES);
  ...
  yield* async function* runVSCodeChecks() {
    ...
    if (e.length || r) {
      ...
      if (r) {
        ...
        if (!n) {
          n = !0;
          yield warningTask(Ye.CHECK_VSCODE);
        }
      ...
      if (!n) {
        yield completedTask(Ye.CHECK_VSCODE);
      }
    }
  }();
  yield runningTask(Ye.CHECK_SCHEMA);
  await delay();
  try {
    await i(m).load({
      rootPath: t.dirname(p.configPath)
    });
  } catch (e) {
    yield failedTask(Ye.CHECK_SCHEMA);
    throw externalError("Failed to load schema.", e);
  }
  yield completedTask(Ye.CHECK_SCHEMA, !0);
  await delay();
...
var Ze = {
  ...
  forward: (e = 1) => `${Xe}${e}C`,
  backward: (e = 1) => `${Xe}${e}D`,
  nextLine: (e = 1) => `${Xe}E`.repeat(e),
  prevLine: (e = 1) => `${Xe}F`.repeat(e),
  left: `${Xe}G`,
  hide: `${Xe}?25l`,
  show: `${Xe}?25h`,
  save: "7",
...
var Qe = {
  screen: `${Xe}2J`,
  up: (e = 1) => `${Xe}1J`.repeat(e),
  down: (e = 1) => `${Xe}J`.repeat(e),
  line: `${Xe}2K`,
  lineEnd: `${Xe}K`,
  lineStart: `${Xe}1K`,
  lines(e) {
...
var et = {
  cursor: Ze,
  scroll: {
    up: (e = 1) => `${Xe}S`.repeat(e),
    down: (e = 1) => `${Xe}T`.repeat(e)
  },
  erase: Qe,
  beep: ""
};
...
tt.exports.createColors = create;

var nt = getDefaultExportFromCjs(tt.exports);
...
!function(e) {
  var t = {};
  it.exports = t, t.eastAsianWidth = function(e) {
...
var T = (e = 0) => t => `[${t + e}m`, P = (e = 0) => t => `[${38 + e};5;${t}m`, W = (e = 0) => (t, r, n) => `[${38 + e};2;${t};${r};${n}m`, ot = {
  modifier: {
    reset: [ 0, 0 ],
    bold: [ 1, 22 ],
    dim: [ 2, 22 ],
...
var st = function tD() {
...
}(), Dt = new Set([ "", "" ]), ct = "]8;;", N = e => `${Dt.values().next().value}[${e}m`, L = e => `${Dt.values().next().value}${ct}${e}`, y$1 = (e, t, r) => {
  var n = [ ...t ];
  var i = !1, a = !1, s = A(S$1(e[e.length - 1]));
  for (var [D, c] of n.entries()) {
    var l = A(c);
    if (s + l <= r ? e[e.length - 1] += c : (e.push(c), s = 0), Dt.has(c) && (i = !0, 
    a = n.slice(D + 1).join("").startsWith(ct)), i) {
      a ? "" === c && (i = !1, a = !1) : "m" === c && (i = !1);
      continue;
    }
  ...
  for (var [p, m] of h.entries()) {
    if (a += m, Dt.has(m)) {
      var {groups: g} = new RegExp(`(?:\\[(?<code>\\d+)m|\\${ct}(?<uri>.*))`).exec(h.slice(p).join("")) || {
        groups: {}
      };
      if (void 0 !== g.code) {
...
var lt = Object.defineProperty, a$1 = (e, t, r) => (((e, t, r) => {
  t in e ? lt(e, t, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
...
var ft = new Map([ [ "k", "up" ], [ "j", "down" ], [ "h", "left" ], [ "l", "right" ] ]), ht = new Set([ "up", "down", "left", "right", "space", "enter" ]);
...
let pt = class x {
  ...
  onKeypress(e, t) {
    if ("error" === this.state && (this.state = "active"), t?.name && !this._track && ft.has(t.name) && this.emit("cursor", ft.get(t.name)), 
    t?.name && ht.has(t.name) && this.emit("cursor", t.name), e && ("y" === e.toLowerCase() || "n" === e.toLowerCase()) && this.emit("confirm", "y" === e.toLowerCase()), 
    ...
    if (e !== this._prevFrame) {
      if ("initial" === this.state) {
        ...
        if (this.restoreCursor(), t && 1 === t?.length) {
          ...
          var n = e.split("\n");
          this.output.write(n[r]), this._prevFrame = e, this.output.write(et.cursor.move(0, n.length - r - 1));
          return;
        } else if (t && t?.length > 1) {
          var i = t[0];
          this.output.write(et.cursor.move(0, i)), this.output.write(et.erase.down());
          var a = e.split("\n").slice(i);
...
var mt = Object.defineProperty, MD = (e, t, r) => (((e, t, r) => {
  t in e ? mt(e, t, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
  ...
  constructor(e) {
    super(e), MD(this, "valueWithCursor", ""), this.on("finalize", (() => {
      ...
      if (this.cursor >= this.value.length) {
        this.valueWithCursor = `${this.value}${nt.inverse(nt.hidden("_"))}`;
      } else {
        var e = this.value.slice(0, this.cursor), t = this.value.slice(this.cursor);
        this.valueWithCursor = `${e}${nt.inverse(t[0])}${t.slice(1)}`;
      }
    }));
  }
  get cursor() {
...
var vt = globalThis.process.platform.startsWith("win");
...
var gt = function q() {
...
}(), o = (e, t) => gt ? e : t, Ct = o("◆", "*"), Et = o("■", "x"), Ft = o("▲", "x"), yt = o("◇", "o"), wt = o("┌", "T"), bt = o("│", "|"), Bt = o("└", "—"), St = o("●", ">"), xt = o("○", " "), y = e => {
  switch (e) {
   case "initial":
   case "active":
    return nt.cyan(Ct);
  ...
  render() {
    var t = `${nt.gray(bt)}\n${y(this.state)}  ${e.message}\n`, r = e.placeholder ? nt.inverse(e.placeholder[0]) + nt.dim(e.placeholder.slice(1)) : nt.inverse(nt.hidden("_")), n = this.value ? this.valueWithCursor : r;
    switch (this.state) {
     case "error":
      return `${t.trim()}\n${nt.yellow(bt)}  ${n}\n${nt.yellow(Bt)}  ${nt.yellow(this.error)}\n`;

     case "submit":
      return `${t}${nt.gray(bt)}  ${nt.dim(this.value || e.placeholder)}`;

     case "cancel":
      return `${t}${nt.gray(bt)}  ${nt.strikethrough(nt.dim(this.value ?? ""))}${this.value?.trim() ? "\n" + nt.gray(bt) : ""}`;

     default:
      return `${t}${nt.cyan(bt)}  ${n}\n${nt.cyan(Bt)}\n`;
    }
  }
}).prompt(), se = e => {
  ...
  return new xD({
    ...
    render() {
      ...
      switch (this.state) {
       case "submit":
        return `${n}${nt.gray(bt)}  ${nt.dim(i)}`;

       case "cancel":
        return `${n}${nt.gray(bt)}  ${nt.strikethrough(nt.dim(i))}\n${nt.gray(bt)}`;

       default:
        return `${n}${nt.cyan(bt)}  ${this.value ? `${nt.green(St)} ${t}` : `${nt.dim(xt)} ${nt.dim(t)}`} ${nt.dim("/")} ${this.value ? `${nt.dim(xt)} ${nt.dim(r)}` : `${nt.green(St)} ${r}`}\n${nt.cyan(Bt)}\n`;
      }
    }
  }).prompt();
}, ue = (e = "") => {
  process.stdout.write(`${nt.gray(Bt)}  ${nt.red(e)}\n\n`);
};
...
var Pt = "win32" === process.platform || "cygwin" === process.env.OSTYPE || "msys" === process.env.OSTYPE;
...
var getPathInfo = (e, t) => {
  var r = t.colon || jt;
  var n = e.match(/\//) || Pt && e.match(/\\/) ? [ "" ] : [ ...Pt ? [ process.cwd() ] : [], ...(t.path || process.env.PATH || "").split(r) ];
  var i = Pt ? t.pathExt || process.env.PATHEXT || ".EXE;.CMD;.BAT;.COM" : "";
  var a = Pt ? i.split(r) : [ "" ];
  if (Pt) {
    if (-1 !== e.indexOf(".") && "" !== a[0]) {
      a.unshift("");
...
Ut.exports = pathKey$1;

Ut.exports.default = pathKey$1;
...
function resolveCommandAttempt(e, t) {
  ...
  if (s) {
    s = _t.resolve(i ? e.options.cwd : "", s);
  }
  return s;
}
...
qt.command = function escapeCommand(e) {
  return e = e.replace(Ht, "^$1");
};

qt.argument = function escapeArgument(e, t) {
  e = (e = `"${e = (e = (e = `${e}`).replace(/(\\*)"/g, '$1$1\\"')).replace(/(\\*)$/, "$1$1")}"`).replace(Ht, "^$1");
  if (t) {
    e = e.replace(Ht, "^$1");
  }
  return e;
...
var Zt = function readShebang$1(e) {
  var t = Buffer.alloc(150);
  var r;
  try {
    r = Yt.openSync(e, "r");
    Yt.readSync(r, t, 0, 150, 0);
    Yt.closeSync(r);
  } catch (e) {}
  return shebangCommand(t.toString());
};

var Qt = "win32" === process.platform;

var er = /\.(?:com|exe)$/i;

var tr = /node_modules[\\/].bin[\\/][^\\/]+\.cmd$/i;
...
function parseNonShell(e) {
  ...
  if (e.options.forceShell || r) {
    var n = tr.test(t);
    e.command = zt.normalize(e.command);
    e.command = Xt.command(e.command);
    e.args = e.args.map((e => Xt.argument(e, n)));
...
function spawn(e, t, r) {
  var n = ar(e, t, r);
  var i = ir.spawn(n.command, n.args, n.options);
  ur.hookChildProcess(i, n);
  return i;
}

$t.exports = spawn;

$t.exports.spawn = spawn;

$t.exports.sync = function spawnSync(e, t, r) {
  var n = ar(e, t, r);
  var i = ir.spawnSync(n.command, n.args, n.options);
  i.error = i.error || ur.verifyENOENTSync(i.status, n);
  return i;
};

$t.exports._parse = ar;

$t.exports._enoent = ur;

var or = getDefaultExportFromCjs($t.exports);
...
var sr = Object.getOwnPropertyDescriptor(Function.prototype, "toString");

var Dr = Object.getOwnPropertyDescriptor(Function.prototype.toString, "name");
...
function mimicFunction(e, t, {ignoreNonConfigurable: r = !1} = {}) {
  ...
  ((e, t, r) => {
    ...
    Object.defineProperty(i, "name", Dr);
...
var getSignals = () => {
  ...
  return [ ...fr, ...e ].map(normalizeSignal);
};
...
var makeError = ({stdout: e, stderr: t, all: r, error: n, signal: i, exitCode: a, command: s, escapedCommand: D, timedOut: c, isCanceled: l, killed: d, parsed: {options: {timeout: f, cwd: h = E.cwd()}}}) => {
  var p = void 0 === (i = null === i ? void 0 : i) ? void 0 : hr[i].description;
...
var normalizeStdio = e => {
  ...
  if ((e => pr.some((t => void 0 !== e[t])))(e)) {
    throw new Error(`It's not possible to provide \`stdio\` in combination with one of ${pr.map((e => `\`${e}\``)).join(", ")}`);
  }
  if ("string" == typeof t) {
    return t;
  }
  ...
  var r = Math.max(t.length, pr.length);
  return Array.from({
    length: r
  }, ((e, r) => t[r]));
};
...
mr.push("SIGHUP", "SIGINT", "SIGTERM");

if ("win32" !== process.platform) {
  mr.push("SIGALRM", "SIGABRT", "SIGVTALRM", "SIGXCPU", "SIGXFSZ", "SIGUSR2", "SIGTRAP", "SIGSYS", "SIGQUIT", "SIGIOT");
}

if ("linux" === process.platform) {
  mr.push("SIGIO", "SIGPOLL", "SIGPWR", "SIGSTKFLT");
}
...
var vr = Symbol.for("signal-exit emitter");

var gr = globalThis;

var Cr = Object.defineProperty.bind(Object);
...
var Er = globalThis.process;

var {onExit: Fr} = (yr = processOk(Er) ? new class SignalExit extends SignalExitBase {
  #e="win32" === Er.platform ? "SIGINT" : "SIGHUP";
  #t=new Emitter;
  #r;
  #n;
  #i;
...
}(Er) : new class SignalExitFallback extends SignalExitBase {
  onExit() {
    return () => {};
  }
  load() {}
...
var getNewContentsLength = e => Br ** Math.ceil(Math.log(e) / Math.log(Br));
...
async function getStreamAsBuffer(e, t) {
  ...
  try {
    return arrayBufferToNodeBuffer(await async function getStreamAsArrayBuffer(e, t) {
      return getStreamContents(e, Sr, t);
    }(e, t));
  } catch (e) {
...
var Ar = getDefaultExportFromCjs((function() {
  var e = [];
  var t = new $r({
    objectMode: !0
  });
...
var Or = (async () => {})().constructor.prototype;

var Tr = [ "then", "catch", "finally" ].map((e => [ e, Reflect.getOwnPropertyDescriptor(Or, e) ]));
...
var getEscapedCommand = (e, t) => normalizeArgs(e, t).map((e => (e => {
  if ("string" != typeof e || kr.test(e)) {
    return e;
  }
  return `"${e.replaceAll('"', '\\"')}"`;
})(e))).join(" ");

var Ir = J("execa").enabled;
...
var Nr = (() => {
  var e = gt ? [ "◒", "◐", "◓", "◑" ] : [ "•", "o", "O", "0" ], t = gt ? 80 : 120;
  var r, n, i = !1, a = "";
  var u = (e = "", t = 0) => {
    a = e ?? a, i = !1, clearInterval(n);
    var s = 0 === t ? nt.green(yt) : 1 === t ? nt.red(Et) : nt.red(Ft);
  ...
  process.on("SIGINT", (() => $(1))), process.on("SIGTERM", (() => $(1))), process.on("exit", $), 
  {
    start: (s = "") => {
      i = !0, r = function WD({input: e = w, output: t = b, overwrite: r = !0, hideCursor: n = !0} = {}) {
        ...
        return n && process.stdout.write(et.cursor.hide), e.once("keypress", C), () => {
          e.off("keypress", C), n && process.stdout.write(et.cursor.show), e.isTTY && !vt && e.setRawMode(!1), 
          i.terminal = !1, i.close();
        };
      }(), a = s.replace(/\.+$/, ""), process.stdout.write(`${nt.gray(bt)}\n`);
      var D = 0, c = 0;
      n = setInterval((() => {
        var t = nt.magenta(e[D]), r = ".".repeat(Math.floor(c)).slice(0, 3);
        process.stdout.write(et.cursor.move(-999, 0)), process.stdout.write(et.erase.down(1)), 
...
async function run(e) {
  ((e = "") => {
    process.stdout.write(`${nt.gray(wt)}  ${e}\n`);
  })("GQL.Tada");
  var r = await question("Where can we get your schema? Point us at an introspection JSON-file, a GraphQL schema file or an endpoint", (async r => {
    try {
      var n = new URL(r);
      Nr.start("Validating the URL.");
      try {
        var i = await fetch(n.toString());
        if (!i.ok) {
          Nr.stop("Validated the URL.");
          return !!await se({
  ...
  if (i) {
    ...
    Nr.stop("Installed packages.");
  } else {
    Nr.start("Writing to package.json.");
    try {
      var a = t.resolve(e, "package.json");
      var s = await d.readFile(a, "utf-8");
      var D = JSON.parse(s);
      if (!D.dependencies) {
        D.dependencies = {};
      }
      if (!D.dependencies["gql.tada"]) {
        D.dependencies["gql.tada"] = "^1.4.3";
      }
      if (!D.devDependencies) {
        D.devDependencies = {};
      }
      if (!D.devDependencies["@0no-co/graphqlsp"]) {
        D.devDependencies["@0no-co/graphqlsp"] = "^1.8.0";
      }
      await d.writeFile(a, JSON.stringify(D, null, 2));
      Nr.stop("Written to package.json.");
    } catch (e) {
      Nr.stop('Failed to write to package.json, you can try adding "gql.tada" and "@0no-co/graphqlsp" yourself.');
    }
  }
  Nr.start("Writing to tsconfig.json.");
  try {
    var l = t.resolve(e, "tsconfig.json");
    var f = await c(l);
    var h = r.endsWith(".json") || r.endsWith(".graphql");
    f.compilerOptions = {
      ...f.compilerOptions,
      plugins: [ {
        name: "@0no-co/graphqlsp",
        schema: h ? t.relative(e, r) : r,
        tadaOutputLocation: t.relative(e, n)
      } ]
    };
    await d.writeFile(l, JSON.stringify(f, null, 2));
  } catch (e) {}
  Nr.stop("Written to tsconfig.json.");
  ((e = "") => {
    process.stdout.write(`${nt.gray(bt)}\n${nt.gray(Bt)}  ${e}\n\n`);
  })("Off to the races!");
}
...
var Pr = Object.assign((async function _main() {
  var e = new Cli({
...
export { Pr as default, generateOutput, generatePersisted, generateSchema, generateTurbo };
