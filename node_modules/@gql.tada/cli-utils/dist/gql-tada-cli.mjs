import { promises as t, existsSync as i } from "node:fs";

import s, { resolve as u } from "node:path";

import { introspectionFromSchema as h, getIntrospectionQuery as c, buildClientSchema as f, buildSchema as p, printSchema as m } from "graphql";

import { minifyIntrospectionQuery as x } from "@urql/introspection";
...
class o {
  constructor(t, i) {
    ...
    this.command(v), this.command([ D ].concat(i ? u : "<command>").join(" ")), this.single = i, 
    this.curr = "";
  }
  command(t, i, s = {}) {
    if (this.single) {
  ...
  describe(t) {
    return this.tree[this.curr || D].describe = Array.isArray(t) ? t : function(t) {
  ...
  option(t, i, s) {
    var u = this.tree[this.curr || v], [h, c] = function(t) {
      return (t || "").split(/^-{1,2}|,|\s+-{1,2}|\s+/).filter(Boolean);
    }(t);
    if (c && c.length > 1 && ([h, c] = [ c, h ]), t = "--" + h, c && c.length > 0) {
      t = `-${c}, ${t}`;
      u.alias[c] = (u.alias[c] || []).concat(h);
    }
    var f = [ t, i || "" ];
    return void 0 !== s ? (f.push(s), u.default[h] = s) : c || (u.default[h] = void 0), 
    u.options.push(f), this;
  }
  action(t) {
    return this.tree[this.curr || D].handler = t, this;
  }
  example(t) {
    return this.tree[this.curr || D].examples.push(t), this;
  }
  version(t) {
    return this.ver = t, this;
  }
  parse(t, i = {}) {
    var s, u, h, c, f = 2, p = e((t = t.slice()).slice(f), {
      alias: {
        h: "help",
        v: "version"
      }
    }), m = this.single, x = this.bin, y = "";
    if (m) {
      c = this.tree[D];
    } else {
      var g, C = 1, S = p._.length + 1;
      for (;C < S; C++) {
        if (s = p._.slice(0, C).join(" "), "string" == typeof (g = this.tree[s])) {
          u = (y = g).split(" "), t.splice(t.indexOf(p._[0]), C, ...u), C += u.length - C;
        } else if (g) {
          y = s;
        } else if (y) {
          break;
      ...
      if (h = void 0 === (c = this.tree[y])) {
        if (this.default) {
          c = this.tree[y = this.default], t.unshift(y), f++;
        } else if (s) {
          return a(x, "Invalid command: " + s);
        }
      }
    }
    if (p.help) {
      return this.help(!m && !h && y);
    }
    if (p.version) {
      return this._version();
    }
    if (!m && void 0 === c) {
      return a(x, "No command specified.");
    }
    var A = this.tree[v];
    i.alias = Object.assign(A.alias, c.alias, i.alias), i.default = Object.assign(A.default, c.default, i.default), 
    s = y.split(" "), ~(u = t.indexOf(s[0], 2)) && t.splice(u, s.length);
    var w = e(t.slice(f), i);
    if (!w || "string" == typeof w) {
      return a(x, w || "Parsed unknown option flag(s)!");
    }
    var F = c.usage.split(/\s+/), B = F.filter((t => "<" === t.charAt(0))), b = w._.splice(0, B.length);
    if (b.length < B.length) {
      return y && (x += " " + y), a(x, "Insufficient arguments!");
    }
  ...
  help(t) {
    console.log(function(t, i, s, u) {
      var h = "", c = i[s], f = "$ " + t, p = i[v], d = t => `${f} ${t}`.replace(/\s+/g, " "), m = [ [ "-h, --help", "Displays this message" ] ];
      if (s === D && m.unshift([ "-v, --version", "Displays current version" ]), c.options = (c.options || []).concat(p.options, m), 
      c.options.length > 0 && (c.usage += " [options]"), h += l("Description", c.describe, n), 
      h += l("Usage", [ c.usage ], d), u || s !== D) {
        u || s === D || (h += l("Aliases", c.alibi, d));
      } else {
        var x, g = /^__/, C = "", S = [];
        for (x in i) {
          "string" == typeof i[x] || g.test(x) || S.push([ x, (i[x].describe || [ "" ])[0] ]) < 3 && (C += `\n    ${f} ${x} --help`);
        }
        h += l("Available Commands", r(S), n), h += "\n  For more info, run any command with the `--help` flag" + C + y;
      }
      return h += l("Options", r(c.options), n), h += l("Examples", c.examples.map(d), n);
    }(this.bin, this.tree, t || D, this.single));
  }
  _version() {
...
C = g, function webpackUniversalModuleDefinition(t, i) {
  C.exports = i();
}(0, (function() {
  return function(t) {
    var i = {};
    ...
    var D = function() {
        ...
        if (3 === s.type && !D && "get" === s.value && g) {
          ...
          if (this.match(":") && !D) {
            ...
            if (this.match("=")) {
              ...
              p = this.finalize(i, new f.AssignmentPattern(y, C));
            } else {
              v = !0;
              p = y;
            }
      ...
      Parser.prototype.parseBinaryExpression = function() {
        ...
        if (u > 0) {
          ...
          while (y > 1) {
            var C = h.pop();
            D = this.startNode(C, g && g.lineStart);
        ...
        if (!this.context.allowYield && this.matchKeyword("yield")) {
          ...
          if (t.type === v || this.match("=>")) {
            ...
            if (p) {
              ...
              var C = this.startNode(i);
              this.expect("=>");
              var S = void 0;
              if (this.match("{")) {
                var A = this.context.allowIn;
                this.context.allowIn = !0;
                S = this.parseFunctionSourceElements();
                this.context.allowIn = A;
              } else {
                S = this.isolateCoverGrammar(this.parseAssignmentExpression);
              }
              var w = S.type !== m.Syntax.BlockStatement;
              ...
              t = h ? this.finalize(C, new f.AsyncArrowFunctionExpression(p.params, S, w)) : this.finalize(C, new f.ArrowFunctionExpression(p.params, S, w));
        ...
        if (this.match(";")) {
          ...
          if (this.matchKeyword("in")) {
            ...
            if (this.match(",")) {
              ...
              t = this.finalize(this.startNode(C), new f.SequenceExpression(S));
            }
            this.expect(";");
          }
        }
      ...
      Parser.prototype.parseFunctionDeclaration = function(t) {
        ...
        if (this.context.strict && C) {
          this.tolerateUnexpectedToken(C, h);
        }
...
F.byteLength = function byteLength(t) {
  var i = getLens(t);
  var s = i[1];
  return 3 * (i[0] + s) / 4 - s;
};

F.toByteArray = function toByteArray(t) {
  var i;
  var s = getLens(t);
  var u = s[0];
  var h = s[1];
  var c = new k(function _byteLength(t, i, s) {
    return 3 * (i + s) / 4 - s;
  }(0, u, h));
  var f = 0;
  var p = h > 0 ? u - 4 : u;
  var m;
  for (m = 0; m < p; m += 4) {
    i = b[t.charCodeAt(m)] << 18 | b[t.charCodeAt(m + 1)] << 12 | b[t.charCodeAt(m + 2)] << 6 | b[t.charCodeAt(m + 3)];
    c[f++] = i >> 16 & 255;
    c[f++] = i >> 8 & 255;
    c[f++] = 255 & i;
  }
  if (2 === h) {
    i = b[t.charCodeAt(m)] << 2 | b[t.charCodeAt(m + 1)] >> 4;
    c[f++] = 255 & i;
  }
  if (1 === h) {
    i = b[t.charCodeAt(m)] << 10 | b[t.charCodeAt(m + 1)] << 4 | b[t.charCodeAt(m + 2)] >> 2;
    c[f++] = i >> 8 & 255;
    c[f++] = 255 & i;
  }
  return c;
...
F.fromByteArray = function fromByteArray(t) {
  var i;
  var s = t.length;
  var u = s % 3;
  var h = [];
  ...
  if (1 === u) {
    h.push(B[(i = t[s - 1]) >> 2] + B[i << 4 & 63] + "==");
  } else if (2 === u) {
    h.push(B[(i = (t[s - 2] << 8) + t[s - 1]) >> 10] + B[i >> 4 & 63] + B[i << 2 & 63] + "=");
  }
  return h.join("");
};
...
function encodeChunk(t, i, s) {
  var u = [];
  for (var h = i; h < s; h += 3) {
    u.push(B[(c = (t[h] << 16 & 16711680) + (t[h + 1] << 8 & 65280) + (255 & t[h + 2])) >> 18 & 63] + B[c >> 12 & 63] + B[c >> 6 & 63] + B[63 & c]);
  }
  var c;
  return u.join("");
}
...
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ P.read = function(t, i, s, u, h) {
  var c, f;
  var p = 8 * h - u - 1;
  var m = (1 << p) - 1;
  var x = m >> 1;
...
P.write = function(t, i, s, u, h, c) {
  ...
  for (;h >= 8; t[s + g] = 255 & p, g += C, p /= 256, h -= 8) {}
  f = f << h | p;
  x += h;
  for (;x > 0; t[s + g] = 255 & f, g += C, f /= 256, x -= 8) {}
  t[s + g - C] |= 128 * S;
};
...
A.isArray = function isArray$3(t) {
  if (Array.isArray) {
...
A.isBoolean = function isBoolean(t) {
  return "boolean" == typeof t;
};

A.isNull = function isNull(t) {
  return null === t;
};

A.isNullOrUndefined = function isNullOrUndefined(t) {
  return null == t;
};

A.isNumber = function isNumber$2(t) {
  return "number" == typeof t;
};

A.isString = function isString$2(t) {
  return "string" == typeof t;
};

A.isSymbol = function isSymbol(t) {
  return "symbol" == typeof t;
};

A.isUndefined = function isUndefined(t) {
  return void 0 === t;
};

A.isRegExp = function isRegExp(t) {
  return "[object RegExp]" === objectToString(t);
};

A.isObject = function isObject$3(t) {
  return "object" == typeof t && null !== t;
};

A.isDate = function isDate(t) {
  return "[object Date]" === objectToString(t);
};

A.isError = function isError(t) {
  return "[object Error]" === objectToString(t) || t instanceof Error;
};

A.isFunction = function isFunction$1(t) {
  return "function" == typeof t;
};

A.isPrimitive = function isPrimitive(t) {
  return null === t || "boolean" == typeof t || "number" == typeof t || "string" == typeof t || "symbol" == typeof t || void 0 === t;
};

A.isBuffer = w.Buffer.isBuffer;
...
var L = [ 1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9 ];
...
class TimSort {
  ...
  mergeLow(t, i, s, u) {
    ...
    while (1) {
      ...
      do {
        ...
        if (0 !== (C = gallopLeft(f[x], c, v, u, 0, h))) {
          for (m = 0; m < C; m++) {
            c[D + m] = c[v + m];
            M[D + m] = M[v + m];
          }
  ...
  mergeHigh(t, i, s, u) {
    ...
    while (1) {
      ...
      do {
        if (0 !== (S = i - gallopRight(f[v], c, t, i, i - 1, h))) {
          i -= S;
          g = (D -= S) + 1;
          y = (x -= S) + 1;
          for (m = S - 1; m >= 0; m--) {
...
var hasOwnProperty = (t, i) => O.call(t, i);

var {isObject: R, isArray: X, isString: J, isNumber: _} = A;
...
var {SYMBOL_PREFIXES: te, UNDEFINED: re, symbol: ie, copy_comments: ne, swap_comments: se} = Q;
...
var {CommentArray: ue} = ae;

var {PREFIX_BEFORE: he, PREFIX_AFTER_PROP: ce, PREFIX_AFTER_COLON: le, PREFIX_AFTER_VALUE: fe, PREFIX_AFTER: pe, PREFIX_BEFORE_ALL: de, PREFIX_AFTER_ALL: me, BRACKET_OPEN: xe, BRACKET_CLOSE: ve, CURLY_BRACKET_OPEN: De, CURLY_BRACKET_CLOSE: ye, COLON: Ee, COMMA: ge, MINUS: Ce, EMPTY: Se, UNDEFINED: Ae, define: we, assign_non_prop_comments: Fe} = Q;

var tokenize$1 = t => oe.tokenize(t, {
  comment: !0,
  loc: !0
});
...
var clean$1 = () => {
  Ie.length = Be.length = 0;
  Me = null;
  Te = Ae;
};

var symbolFor = t => Symbol.for(Te !== Ae ? t + Ee + Te : t);

var transform = (t, i) => Re ? Re(t, i) : i;

var unexpected = () => {
  var t = new SyntaxError(`Unexpected token ${Ue.value.slice(0, 1)}`);
  Object.assign(t, Ue.loc.start);
  throw t;
};

var unexpected_end = () => {
  var t = new SyntaxError("Unexpected end of JSON input");
  Object.assign(t, Me ? Me.loc.end : {
    line: 1,
    column: 0
  });
  throw t;
...
var next = () => {
  var t = Le[++Oe];
  Ne = Ue && t && Ue.loc.end.line === t.loc.start.line || !1;
  Me = Ue;
  Ue = t;
};
...
var type = () => {
  ...
  return "Punctuator" === Ue.type ? Ue.value : Ue.type;
};
...
var assign_comments = t => {
  ...
  we(be, symbolFor(t), ke);
  ke = null;
};

var parse_comments = t => {
  var i = [];
  while (Ue && (is("LineComment") || is("BlockComment"))) {
    var s = {
      ...Ue,
      inline: Ne
    };
...
var ze = function repeat$1(t, i) {
  ...
  if (_e !== t || void 0 === _e) {
    ...
    return Je.substr(0, s);
  }
  while (s > Je.length && i > 1) {
    if (1 & i) {
      Je += t;
    }
    i >>= 1;
  ...
  return Je = (Je += t).substr(0, s);
};

var {isArray: je, isObject: Ke, isFunction: Ge, isNumber: He, isString: $e} = A;

var We = ze;

var {PREFIX_BEFORE_ALL: qe, PREFIX_BEFORE: Ve, PREFIX_AFTER_PROP: Ye, PREFIX_AFTER_COLON: Qe, PREFIX_AFTER_VALUE: Ze, PREFIX_AFTER: et, PREFIX_AFTER_ALL: tt, BRACKET_OPEN: rt, BRACKET_CLOSE: it, CURLY_BRACKET_OPEN: nt, CURLY_BRACKET_CLOSE: st, COLON: at, COMMA: ot, EMPTY: ut, UNDEFINED: ht} = Q;

var ct = /[\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g;
...
var process_comments = (t, i, s, u) => {
  ...
  var c = !1;
  var f = h.reduce(((t, {inline: i, type: u, value: h}) => t + (i ? " " : lt + s) + ((t, i) => i ? `//${t}` : `/*${t}*/`)(h, c = "LineComment" === u)), ut);
  return u || c ? f + lt + s : f;
};
...
var join = (t, i, s) => t ? i ? t + i.trim() + lt + s : t.trimRight() + lt + s : i ? i.trimRight() + lt + s : ut;

var join_content = (t, i, s) => {
  var u = process_comments(i, Ve, s + mt, !0);
  return join(u, t, s);
};
...
var object_stringify = (t, i) => {
  ...
  var h = ut;
  var c = !0;
  (je(dt) ? dt : Object.keys(t)).forEach((i => {
    ...
    u += p || lt + s;
    u += quote(i) + process_comments(t, `${Ye}:${i}`, s) + at + process_comments(t, (t => `${Qe}:${t}`)(i), s) + " " + f + process_comments(t, AFTER_VALUE(i), s);
    h = process_comments(t, AFTER(i), s);
  }));
  u += join(h, process_comments(t, et, s), s);
  return nt + join_content(u, t, i) + st;
};
...
function stringify$1(t, i, s) {
  ...
  switch (typeof u) {
   ...
   case "number":
    return Number.isFinite(u) ? String(u) : ft;
   ...
   case "object":
    return je(u) ? ((t, i) => {
      ...
      for (var f = 0; f < u; f++) {
        ...
        h += join(c, process_comments(t, BEFORE(f), s), s) || lt + s;
        h += stringify$1(f, t, s) || ft;
        h += process_comments(t, AFTER_VALUE(f), s);
        c = process_comments(t, AFTER(f), s);
      }
      h += join(c, process_comments(t, et, s), s);
      return rt + join_content(h, t, i) + it;
...
var vt = [ "[object Number]", "[object String]", "[object Boolean]" ];

var {parse: Dt, tokenize: yt} = Xe;

var stringify = (t, i, s) => {
  var u = (t => $e(t) ? t : He(t) ? We(" ", t) : ut)(s);
  if (!u) {
  ...
  return Ke(t) ? process_comments(t, qe, ut).trimLeft() + h + process_comments(t, tt, ut).trimRight() : h;
};

var {CommentArray: Et} = ae;
...
async function main() {
  Ft.command("generate-schema <target>").describe("Generate a GraphQL schema from a URL or introspection file, this will be generated from the parameters to this command.").option("--header", "Pass a header to be used when fetching the introspection.").option("--output", 'A specialised location to output the schema to, by default we\'ll output the schema to the "schema" defined in your "tsconfig".').example("generate-schema https://example.com --header 'Authorization: Bearer token'").example("generate-schema ./introspection.json").action((async (h, p) => {
    ...
    var D;
    if (v) {
      var y = (Array.isArray(p.header) ? p.header : [ p.header ]).reduce(((t, i) => {
        if (!i) {
          return t;
        }
        var s = i.split(":");
      ...
      if (g.ok) {
        ...
        try {
          ...
          if (S.data) {
            ...
            console.error(`Got invalid response ${JSON.stringify(S)}`);
            return;
          }
        } catch (t) {
          console.error(`Got invalid JSON ${C}`);
          return;
        }
      } else {
        console.error(`Got invalid response ${await g.text()}`);
        return;
      }
    } else {
      var A = u(x, h);
      var w = await t.readFile(A, "utf-8");
      try {
        D = JSON.parse(w);
      } catch (t) {
    ...
    if (!B) {
      ...
      var P = T.compilerOptions.plugins.find((t => "@0no-co/graphqlsp" === t.name));
      B = P.schema;
      if (!P.schema.endsWith(".graphql")) {
        console.error(`Found "${P.schema}" which is not a path to a GraphQL Schema.`);
        return;
      }
    }
    await t.writeFile(u(x, B), m(F), "utf-8");
    ...
    var u = process.cwd();
    var c = s.resolve(u, "tsconfig.json");
    if (!i(c)) {
      console.error("Missing tsconfig.json");
      return;
    }
    var f = await t.readFile(c, "utf-8");
    var p;
    try {
      p = Ct.parse(f);
    } catch (t) {
    ...
    await async function ensureTadaIntrospection(i, u) {
      var c = process.cwd();
      await (async () => {
        try {
          var f = await loadSchema(c, i);
          if (!f) {
