...
var rehydrateGraphQlError = e => {
  if (e && e.message && (e.extensions || "GraphQLError" === e.name)) {
    ...
    return new r.GraphQLError(e.message, e.nodes, e.source, e.positions, e.path, e, e.extensions || {});
  } else {
    return new r.GraphQLError(e);
  }
};
...
var replaceOutsideStrings = (e, n) => n % 2 == 0 ? e.replace(h, "\n") : e;
...
var stringifyDocument = e => {
  ...
  if ("string" == typeof e) {
    ...
    n = y.get(e) || sanitizeDocument(r.print(e));
    y.set(e, n);
  }
...
var getOperationName = e => {
  for (var n of e.definitions) {
    if (n.kind === r.Kind.OPERATION_DEFINITION) {
  ...
  var c = Object.assign(l, {
    ...
    executeRequestOperation(e) {
      ...
      return withPromise(function lazy(e) {
        ...
        var r = a.get(e.key);
        if ("query" === e.kind && r && (r.stale || r.hasNext)) {
          return switchMap(fromValue)(merge([ n, filter((n => n === a.get(e.key)))(fromValue(r)) ]));
        } else {
          return n;
        }
      })));
...
var makeIntrospectionQuery = e => {
  if (w && b === e) {
    ...
    return w = _makeIntrospectionQuery(b = e);
  }
};
...
var _makeIntrospectionQuery = e => ({
  ...
  definitions: [ {
    ...
    operation: r.OperationTypeNode.QUERY,
    selectionSet: {
...
function loadFromSDL(r) {
  var t = new Set;
  var i = null;
  var o = null;
  var load = async () => {
    var t = e.extname(r.file);
    var i = await a.readFile(r.file, {
      encoding: "utf8"
    });
    if (".json" === t) {
      var o = JSON.parse(i);
      ...
      return {
        ...
        schema: n.buildClientSchema(o, {
          assumeValid: !!r.assumeValid
        })
      };
    } else {
      var s = n.buildSchema(i, {
        assumeValidSDL: !!r.assumeValid
      });
      var d = makeIntrospectionQuery(A);
      var u = n.executeSync({
        schema: s,
        document: d
      });
...
var S = [ "name", "tadaOutputLocation", "tadaTurboLocation", "tadaPersistedLocation" ];
...
var parseSchemaConfig = (e, n) => {
  ...
  if (!("schema" in e) || "string" != typeof e.schema) {
...
var x = "undefined" != typeof require ? require.resolve.bind(require) : i.createRequire("undefined" == typeof document ? require("url").pathToFileURL(__filename).href : o && o.src || new URL("dist/gql-tada-internal.js", document.baseURI).href).resolve;

var resolveExtend = async (e, n) => {
  try {
    return toTSConfigPath(x(e, {
      paths: [ n ]
    }));
  } catch (e) {
    return null;
...
var toTSConfigPath = e => ".json" !== s.extname(e) ? s.resolve(O, e, "tsconfig.json") : s.resolve(O, e);

var readTSConfigFile = async e => {
  var n = toTSConfigPath(e);
  var r = await d.readFile(n, "utf8");
  var a = t.parseConfigFileTextToJson(n, r);
  if (a.error) {
...
var loadConfig = async e => {
  ...
  var load = async e => {
    ...
    var a = (e => e && e.compilerOptions && e.compilerOptions.plugins && e.compilerOptions.plugins.find((e => "@0no-co/graphqlsp" === e.name || "gql.tada/lsp" === e.name)) || null)(r);
    if (a) {
      return {
        pluginConfig: a,
        configPath: e,
...
exports.outputIntrospectionFile = function outputIntrospectionFile(e, n) {
  if (/\.d\.ts$/.test(n.fileType)) {
    ...
    var a = [ L, D, `export type introspection = ${r};\n`, "import * as gqlTada from 'gql.tada';\n" ];
    if (!("name" in e) || !e.name) {
    ...
    return [ L, M, `const introspection = ${t} as const;\n`, "export { introspection };" ].join("\n");
  }
