...
import { SchemaMetaFieldDef as _, TypeMetaFieldDef as D, TypeNameMetaFieldDef as N, isCompositeType as A, Kind as k, isScalarType as F, isObjectType as C, isInterfaceType as L, isUnionType as O, isEnumType as x, isInputObjectType as M, getNamedType as P, isOutputType as w, isInputType as R, GraphQLEnumType as j, GraphQLBoolean as U, isAbstractType as V, assertAbstractType as Y, doTypesOverlap as $, DirectiveLocation as G, visit as B, parse as Q, BREAK as X, isListType as W, isNonNullType as J, GraphQLInterfaceType as z, GraphQLObjectType as K, GraphQLInputObjectType as H, getNullableType as q, GraphQLList as Z, GraphQLNonNull as ee } from "graphql";
        ...
        if (t.name) {
          ...
          if (t.kind === Dt.NAMED_TYPE && (null === (r = t.prevState) || void 0 === r ? void 0 : r.kind) === Dt.IMPLEMENTS) {
            if (i.interfaceDef) {
              ...
              i.objectTypeDef = new K(Object.assign(Object.assign({}, p), {
    ...
    return function getSuggestionsForDirective(e, t, n, r) {
      ...
      if (null === (i = t.prevState) || void 0 === i ? void 0 : i.kind) {
        var a = n.getDirectives().filter((e => function canUseDirective(e, t) {
          ...
          switch (n) {
           case Dt.QUERY:
            return i.includes(G.QUERY);

           case Dt.MUTATION:
            return i.includes(G.MUTATION);

           case Dt.SUBSCRIPTION:
            return i.includes(G.SUBSCRIPTION);

           case Dt.FIELD:
           case Dt.ALIASED_FIELD:
            return i.includes(G.FIELD);

           case Dt.FRAGMENT_DEFINITION:
            return i.includes(G.FRAGMENT_DEFINITION);

           case Dt.FRAGMENT_SPREAD:
            return i.includes(G.FRAGMENT_SPREAD);

           case Dt.INLINE_FRAGMENT:
            return i.includes(G.INLINE_FRAGMENT);

           case Dt.SCHEMA_DEF:
            return i.includes(G.SCHEMA);

           case Dt.SCALAR_DEF:
            return i.includes(G.SCALAR);

           case Dt.OBJECT_TYPE_DEF:
            return i.includes(G.OBJECT);

           case Dt.FIELD_DEF:
            return i.includes(G.FIELD_DEFINITION);

           case Dt.INTERFACE_DEF:
            return i.includes(G.INTERFACE);

           case Dt.UNION_DEF:
            return i.includes(G.UNION);

           case Dt.ENUM_DEF:
            return i.includes(G.ENUM);

           case Dt.ENUM_VALUE:
            return i.includes(G.ENUM_VALUE);

           case Dt.INPUT_DEF:
            return i.includes(G.INPUT_OBJECT);

           case Dt.INPUT_VALUE_DEF:
            switch (null == r ? void 0 : r.kind) {
             case Dt.ARGUMENTS_DEF:
              return i.includes(G.ARGUMENT_DEFINITION);

             case Dt.INPUT_DEF:
              return i.includes(G.INPUT_FIELD_DEFINITION);
            }
          }
          return !1;
        }(t.prevState, e)));
...
function create(e) {
  ...
  c.getApplicableRefactors = (t, n, r, i, a, o) => {
    ...
    var u = E(t, "number" == typeof n ? n : n.pos, e);
